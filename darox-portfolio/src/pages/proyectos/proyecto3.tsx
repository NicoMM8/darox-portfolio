        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 flex flex-col md:flex-row gap-12 items-center md:items-start">
          ...
          <div className="flex-1 flex flex-col justify-center gap-8">
            ...
            <p className="text-lg text-gray-300 max-w-xl animate-fade-in-up delay-100">
              Proyecto integral de transformación digital y diseño avanzado para una marca líder. Innovación, tecnología y resultados medibles.
            </p>
            {/* Badges de categoría */}
            <div className="flex gap-3 mt-2">
              <span className="bg-blue-900/60 text-white/90 text-base px-4 py-2 rounded-lg border border-white/10 font-medium">Transformación</span>
              <span className="bg-blue-900/60 text-white/90 text-base px-4 py-2 rounded-lg border border-white/10 font-medium">Innovación</span>
            </div>
          </div>
          ...
          <div className="flex-1 w-full max-w-md">
            <div className="rounded-3xl bg-gradient-to-br from-[#0e1a3a]/80 to-[#1a237e]/60 border border-white/10 shadow-2xl p-8 flex flex-col gap-6 backdrop-blur-md">
              ...
              <div>
                ...
                <span className="block text-white font-semibold">Transformación Digital, Diseño, Estrategia</span>
              </div>
              {/* Categoría */}
              <div>
                <span className="block text-gray-400 text-sm mb-1">Categoría</span>
                <span className="block text-white font-semibold">Innovación Empresarial</span>
              </div>
              {/* Cliente */}
              <div>
          ...
          <div className="flex flex-col md:flex-row gap-12">
            ...
            <div className="flex-1">
              ...
              <ul className="text-gray-200 text-base space-y-2 list-disc list-inside">
                ...
                <li> diseño preparado para soportar mayor tráfico.</li>
              </ul>
            </div>
            ...
            <div className="flex-1">
              ...
              <ul className="text-gray-200 text-base space-y-2 list-disc list-inside">
                <li> el sitio se ajusta perfectamente a móviles y escritorios.</li>
                <li> navegación fluida y consistente en cualquier dispositivo.</li>
              </ul>
            </div>
          </div>
        </section>
